...
color = [(0, 0, 255), (0, 255, 0), (255, 0, 0), (255, 255, 0), (255, 0, 255), (0, 255, 255), (128, 255, 0), (128, 0, 255), (255, 128, 0), (255, 0, 128)]
width = 128
...
def decode(point, action, point_color=True, ref_point=None):
    ...
    dxy = new_point.max(1)[0].max(1)[0] + 1e-9
    if point_color:
...
class DDPG(object):
    ...
    def evaluate(self, state, action, target=False):
        ...
        L2_reward = ((last_point - tgt_point) ** 2).sum(2).sqrt().mean(1) - ((new_point - tgt_point) ** 2).sum(2).sqrt().mean(1)
